...
/* @partidos/estadios/Union Berlin.twig */
class __TwigTemplate_38a0a3a6409da732ff8aec380658e0e8 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<p class=\"fw-bold lh-1 h4 text-start w-100\">Section: South stand (behind the goal)</p>
\t\t\t<div class=\"cnRed1\">
...
\t\t<form class=\"d-flex flex-column flex-fill justify-content-center align-items-end\" method=\"post\" action=\"http://localhost/AllTickets/matches/";
        // line 34
...
\t\t\t<input class=\"d-none\" type=\"text\" value=\"Tribuna Superiorr\" name=\"seccion\" id=\"seccion\">
...
\t\t\t<input class=\"d-none\" type=\"text\" value=\"Tribuna Inferiorr\" name=\"seccion\" id=\"seccion\">
\t\t\t<p class=\"fs-6 cGry3 mb-0\">Per ticket</p>
\t\t\t<div>
\t\t\t\t<input type=\"number\" name=\"entradas\" id=\"entradas\" class=\"w-50 mt-1\">
\t\t\t\t<button type=\"submit\" class=\"btn pri\">Buy</button>
...
\t<div class=\"d-flex flex-fill flex-row flex-grow-1 align-items-stretch col-8 ps-3 pb-2 pt-2\">
\t\t<div class=\"justify-content-center align-items-center d-flex flex-column\">
\t\t\t<p class=\"fw-bold lh-1 h4 text-start w-100\">Section: North stand (behind the goal)</p>
\t\t\t<div class=\"cnRed1\">
\t\t\t\t<p class=\"fw-bold m-0 lh-1\">4 tickets left</p>
\t\t\t\t<p class=\"m-0 lh-1\">in our website</p>
\t\t\t</div>
...
\t<div class=\"d-flex flex-fill flex-row flex-grow-1 align-items-stretch col-8 ps-3 pb-2 pt-2\">
\t\t<div class=\"justify-content-center align-items-center d-flex flex-column\">
\t\t\t<p class=\"fw-bold lh-1 h4 text-start w-100\">Section: Visiting fans' stand</p>
\t\t\t<div class=\"fw-light cGry2 \">
\t\t\t\t<em>Electronic entry</em>
\t\t\t\t<br>
\t\t\t\t<div class=\"d-flex flex-top cGry1 fw-bold lh-1\">
...
";
    ...
    {
        return "@partidos/estadios/Union Berlin.twig";
    }
    ...
    {
        return new Source("", "@partidos/estadios/Union Berlin.twig", "C:\\xampp\\htdocs\\AllTickets\\modules\\partidos\\templates\\estadios\\Union Berlin.twig");
    }
