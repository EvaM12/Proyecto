...
class __TwigTemplate_088af545fe6538de8917b37f462d5bec extends Template
{
    ...
    ";
        // line 8
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 8), 8, $this->source), "html", null, true);
        echo "
    <main>
        ";
        // line 10
    ...
    {
        return array (  53 => 13,  47 => 10,  42 => 8,  39 => 7,);
    }
